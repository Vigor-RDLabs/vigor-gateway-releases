...
## Current Release
- Latest published release as of August 6, 2026: [`v1.0.6`](https://github.com/Vigor-RDLabs/vigor-gateway-releases/releases/tag/v1.0.6)
- Linux asset:
  `vigor-gateway-v1.0.6-linux-x86_64.tar.gz`
- Tarball checksum asset:
  `vigor-gateway-v1.0.6-linux-x86_64.tar.gz.sha256`
...
```bash
curl -LO https://github.com/Vigor-RDLabs/vigor-gateway-releases/releases/download/v1.0.6/vigor-gateway-v1.0.6-linux-x86_64.tar.gz
curl -LO https://github.com/Vigor-RDLabs/vigor-gateway-releases/releases/download/v1.0.6/vigor-gateway-v1.0.6-linux-x86_64.tar.gz.sha256
sha256sum -c vigor-gateway-v1.0.6-linux-x86_64.tar.gz.sha256
tar -xzf vigor-gateway-v1.0.6-linux-x86_64.tar.gz
cd vigor-gateway-v1.0.6-linux-x86_64
sudo ./install.sh
```
